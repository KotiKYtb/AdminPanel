...
from Error.display_error import display_error
...
class AdminPanelApp:
    def __init__(self):
        ...
        # self.window.configure(bg_color='red') A configurer #011627
        ...
        self.register_button = ctk.CTkButton(self.register_frame, text="Register", command=self.register_user, width=75)
        ...
        # Options for change all panel colors
        ...
        self.all_reset_settings = ["1000x600", "English", "add_panel_colors", "add_bg_colors", "add_text_colors"] # Not use right now
        ...
        self.apply_button = ctk.CTkButton(self.settings_frame, text="Apply", command=self.apply_settings, width=75)
        ...
        self.top_menu_onglet_get_cam_button = ctk.CTkButton(self.main_window_frame, command=self.show_get_cam_window_frame, text="Get Webcam", width=120, height=40, fg_color="#ffffff", text_color="#000000")
        self.top_menu_onglet_get_all_button = ctk.CTkButton(self.main_window_frame, text="Get All", width=120, height=40, fg_color="#ffffff", text_color="#000000")
        self.top_menu_onglet_ddos_button = ctk.CTkButton(self.main_window_frame, command=self.show_ddos_window_frame, text="DDOS", width=120, height=40, fg_color="#ffffff", text_color="#000000")
        self.top_menu_onglet_keylogger_button = ctk.CTkButton(self.main_window_frame, text="KeyLogger", width=120, height=40, fg_color="#ffffff", text_color="#000000")
        self.top_menu_onglet_send_mail_button = ctk.CTkButton(self.main_window_frame, command=self.show_send_mail_window_frame, text="Send Mail", width=120, height=40, fg_color="#ffffff", text_color="#000000")
        ...
        self.top_menu_onglet_get_cam_button_get_cam = ctk.CTkButton(self.main_window_frame_get_cam, command=self.show_get_cam_window_frame, text="Get Webcam", width=120, height=40, fg_color="#ffffff", text_color="#000000")
        self.top_menu_onglet_get_all_button_get_cam = ctk.CTkButton(self.main_window_frame_get_cam, text="Get All", width=120, height=40, fg_color="#ffffff", text_color="#000000")
        self.top_menu_onglet_ddos_button_get_cam = ctk.CTkButton(self.main_window_frame_get_cam, command=self.show_ddos_window_frame, text="DDOS", width=120, height=40, fg_color="#ffffff", text_color="#000000")
        self.top_menu_onglet_keylogger_button_get_cam = ctk.CTkButton(self.main_window_frame_get_cam, text="KeyLogger", width=120, height=40, fg_color="#ffffff", text_color="#000000")
        self.top_menu_onglet_send_mail_button_get_cam = ctk.CTkButton(self.main_window_frame_get_cam, command=self.show_send_mail_window_frame, text="Send Mail", width=120, height=40, fg_color="#ffffff", text_color="#000000")
        ...
        self.top_menu_onglet_get_cam_button_send_mail = ctk.CTkButton(self.main_window_frame_send_mail, command=self.show_get_cam_window_frame, text="Get Webcam", width=120, height=40, fg_color="#ffffff", text_color="#000000")
        self.top_menu_onglet_get_all_button_send_mail = ctk.CTkButton(self.main_window_frame_send_mail, text="Get All", width=120, height=40, fg_color="#ffffff", text_color="#000000")
        self.top_menu_onglet_ddos_button_send_mail = ctk.CTkButton(self.main_window_frame_send_mail, command=self.show_ddos_window_frame, text="DDOS", width=120, height=40, fg_color="#ffffff", text_color="#000000")
        self.top_menu_onglet_keylogger_button_send_mail = ctk.CTkButton(self.main_window_frame_send_mail, text="KeyLogger", width=120, height=40, fg_color="#ffffff", text_color="#000000")
        self.top_menu_onglet_send_mail_button_send_mail = ctk.CTkButton(self.main_window_frame_send_mail, command=self.show_send_mail_window_frame, text="Send Mail", width=120, height=40, fg_color="#ffffff", text_color="#000000")
        ...
        self.templates_list_loader = ["Custom", "Esaip", "Fnac", "Facebook", "Irigo", "SNCF"]
        ...
        self.send_mail_button = ctk.CTkButton(self.main_window_frame_send_mail, command=lambda: send_mail(self.to_input.get()), text="Send", width=120, height=40, fg_color="#ffffff", text_color="#000000")
        
        # DDoS window
        self.ddos_frame = ctk.CTkFrame(self.window, width=1000, height=600)

        self.top_menu_onglet_get_cam_button_ddos = ctk.CTkButton(self.ddos_frame, command=self.show_get_cam_window_frame, text="Get Webcam", width=120, height=40, fg_color="#ffffff", text_color="#000000")
        self.top_menu_onglet_get_all_button_ddos = ctk.CTkButton(self.ddos_frame, text="Get All", width=120, height=40, fg_color="#ffffff", text_color="#000000")
        self.top_menu_onglet_ddos_button_ddos = ctk.CTkButton(self.ddos_frame, command=self.show_ddos_window_frame, text="DDOS", width=120, height=40, fg_color="#ffffff", text_color="#000000")
        self.top_menu_onglet_keylogger_button_ddos = ctk.CTkButton(self.ddos_frame, text="KeyLogger", width=120, height=40, fg_color="#ffffff", text_color="#000000")
        self.top_menu_onglet_send_mail_button_ddos = ctk.CTkButton(self.ddos_frame, command=self.show_send_mail_window_frame, text="Send Mail", width=120, height=40, fg_color="#ffffff", text_color="#000000")
        ...
        ctk.CTkButton(self.window, text="♾️", width=30, height=30, fg_color="#e6dc09", hover_color="#c1b80a", command=self.show_verif_window_frame).place(rely=0.99, relx=0.80, anchor="sw")
...
#################################### FRONTEND ####################################
    ...
    def show_main_window_frame(self):
        ...
        # Onglet
        self.place_object(self.top_menu_onglet_get_cam_button, posx=0, posy=0, relposx=0.07, relposy=0.05, anchor_txt="center")
        self.place_object(self.top_menu_onglet_get_all_button, posx=0, posy=0, relposx=0.2, relposy=0.05, anchor_txt="center")
        self.place_object(self.top_menu_onglet_ddos_button, posx=0, posy=0, relposx=0.33, relposy=0.05, anchor_txt="center")
        self.place_object(self.top_menu_onglet_keylogger_button, posx=0, posy=0, relposx=0.46, relposy=0.05, anchor_txt="center")
        self.place_object(self.top_menu_onglet_send_mail_button, posx=0, posy=0, relposx=0.59, relposy=0.05, anchor_txt="center")

    def show_get_cam_window_frame(self):
        self.show_frame(self.main_window_frame_get_cam)
        # Onglet
        self.place_object(self.top_menu_onglet_get_cam_button_get_cam, posx=0, posy=0, relposx=0.07, relposy=0.05, anchor_txt="center")
        self.place_object(self.top_menu_onglet_get_all_button_get_cam, posx=0, posy=0, relposx=0.2, relposy=0.05, anchor_txt="center")
        self.place_object(self.top_menu_onglet_ddos_button_get_cam, posx=0, posy=0, relposx=0.33, relposy=0.05, anchor_txt="center")
        self.place_object(self.top_menu_onglet_keylogger_button_get_cam, posx=0, posy=0, relposx=0.46, relposy=0.05, anchor_txt="center")
        self.place_object(self.top_menu_onglet_send_mail_button_get_cam, posx=0, posy=0, relposx=0.59, relposy=0.05, anchor_txt="center")
        # display cam
    ...
    def show_send_mail_window_frame(self):
        ...
        # Onglet
        self.place_object(self.top_menu_onglet_get_cam_button_send_mail, posx=0, posy=0, relposx=0.07, relposy=0.05, anchor_txt="center")
        self.place_object(self.top_menu_onglet_get_all_button_send_mail, posx=0, posy=0, relposx=0.2, relposy=0.05, anchor_txt="center")
        self.place_object(self.top_menu_onglet_ddos_button_send_mail, posx=0, posy=0, relposx=0.33, relposy=0.05, anchor_txt="center")
        self.place_object(self.top_menu_onglet_keylogger_button_send_mail, posx=0, posy=0, relposx=0.46, relposy=0.05, anchor_txt="center")
        self.place_object(self.top_menu_onglet_send_mail_button_send_mail, posx=0, posy=0, relposx=0.59, relposy=0.05, anchor_txt="center")
        # Display mail system
    ...
    def show_ddos_window_frame(self):
        ...
        #Onglets
        self.place_object(self.top_menu_onglet_get_cam_button_ddos, posx=0, posy=0, relposx=0.07, relposy=0.05, anchor_txt="center")
        self.place_object(self.top_menu_onglet_get_all_button_ddos, posx=0, posy=0, relposx=0.2, relposy=0.05, anchor_txt="center")
        self.place_object(self.top_menu_onglet_ddos_button_ddos, posx=0, posy=0, relposx=0.33, relposy=0.05, anchor_txt="center")
        self.place_object(self.top_menu_onglet_keylogger_button_ddos, posx=0, posy=0, relposx=0.46, relposy=0.05, anchor_txt="center")
        self.place_object(self.top_menu_onglet_send_mail_button_ddos, posx=0, posy=0, relposx=0.59, relposy=0.05, anchor_txt="center")
